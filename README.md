...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->simple()->price()<br>    ->send(<br>        $q->withIds('string')<br>        ->withVsCurrencies('string')<br>        ->withIncludeMarketCap('string')<br>        ->withInclude24hrVol('string')<br>        ->withInclude24hrChange('string')<br>        ->withIncludeLastUpdatedAt('string')<br>        ->withPrecision('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->simple()->tokenPrice('{id}')<br>    ->send(<br>        $q->withContractAddresses('string')<br>        ->withVsCurrencies('string')<br>        ->withIncludeMarketCap('string')<br>        ->withInclude24hrVol('string')<br>        ->withInclude24hrChange('string')<br>        ->withIncludeLastUpdatedAt('string')<br>        ->withPrecision('string')<br>    );</pre></code>|
...
| <i>sample</i> |     ```php $result = \$apiClient->set()->simple()->supportedVsCurrencies()->send();```|


# <h2 id='cust-coins'>_WW_ coins </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/coins/list` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins()->list()<br>    ->send(<br>        $q->withIncludePlatform('boolean')<br>    );</pre></code>|
| <b>2.<b>   | `/coins/markets` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins()->markets()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withIds('string')<br>        ->withCategory('string')<br>        ->withOrder('string')<br>        ->withPerPage('integer')<br>        ->withPage('integer')<br>        ->withSparkline('boolean')<br>        ->withPriceChangePercentage('string')<br>    );</pre></code>|
| <b>3.<b>   | `/coins/{id}` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')<br>    ->send(<br>        $q->withLocalization('string')<br>        ->withTickers('boolean')<br>        ->withMarketData('boolean')<br>        ->withCommunityData('boolean')<br>        ->withDeveloperData('boolean')<br>        ->withSparkline('boolean')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->tickers()<br>    ->send(<br>        $q->withExchangeIds('string')<br>        ->withIncludeExchangeLogo('string')<br>        ->withPage('integer')<br>        ->withOrder('string')<br>        ->withDepth('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->history()<br>    ->send(<br>        $q->withDate('string')<br>        ->withLocalization('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->marketChart()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withDays('string')<br>        ->withInterval('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->marketChart()->range()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withFrom('string')<br>        ->withTo('string')<br>    );</pre></code>|


# <h2 id='cust-contract'>_WW_ contract </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->coins('{id}')->contract('{contract_address}')->send();```|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->contract('{contract_address}')->marketChart()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withDays('string')<br>    );</pre></code>|
...
|                  | <i>URL Keys</i> : 3<br><br> ✔️  <code>withVsCurrency('string')</code>❗️<br> ✔️  <code>withFrom('string')</code>❗️<br> ✔️  <code>withTo('string')</code>❗️<br><br><details><summary>see description</summary><ol><li><code> vs_currency</code> ➞  string <p> ◽️ The target currency of market data (usd, eur, jpy, etc.)</p></li><li><code> from</code> ➞  string <p> ◽️ From date in UNIX Timestamp (eg. 1392577232)</p></li><li><code> to</code> ➞  string <p> ◽️ To date in UNIX Timestamp (eg. 1422577232)</p></li></ol></details> |
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->contract('{contract_address}')->marketChart()->range()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withFrom('string')<br>        ->withTo('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins('{id}')->ohlc()<br>    ->send(<br>        $q->withVsCurrency('string')<br>        ->withDays('string')<br>    );</pre></code>|


# <h2 id='cust-asset_platforms'>_WW_ asset_platforms </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->assetPlatforms()<br>    ->send(<br>        $q->withFilter('string')<br>    );</pre></code>|


# <h2 id='cust-categories'>_WW_ categories </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.</b>   | `/coins/categories/list`  |
|                        | <code>coins()->categories()->list()</code> <br><br><blockquotes>List all categories<blockquotes><br><br> |
| <i>sample</i> |     ```php $result = \$apiClient->set()->coins()->categories()->list()->send();```|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->coins()->categories()<br>    ->send(<br>        $q->withOrder('string')<br>    );</pre></code>|


# <h2 id='cust-exchanges'>_WW_ exchanges </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/exchanges` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->exchanges()<br>    ->send(<br>        $q->withPerPage('integer')<br>        ->withPage('string')<br>    );</pre></code>|
...
| <i>sample</i> |     ```php $result = \$apiClient->set()->exchanges()->list()->send();```|
| <b>3.<b>   | `/exchanges/{id}` |
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->exchanges('{id}')->send();```|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->exchanges('{id}')->tickers()<br>    ->send(<br>        $q->withCoinIds('string')<br>        ->withIncludeExchangeLogo('string')<br>        ->withPage('integer')<br>        ->withDepth('string')<br>        ->withOrder('string')<br>    );</pre></code>|


# <h2 id='cust-indexes'>_WW_ indexes </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/indexes` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->indexes()<br>    ->send(<br>        $q->withPerPage('integer')<br>        ->withPage('integer')<br>    );</pre></code>|
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->indexes('{market_id}''{id}')->send();```|
| <b>3.</b>   | `/indexes/list`  |
|                        | <code>indexes()->list()</code> <br><br><blockquotes>list market indexes id and name<blockquotes><br><br> |
| <i>sample</i> |     ```php $result = \$apiClient->set()->indexes()->list()->send();```|


# <h2 id='cust-derivatives'>_WW_ derivatives </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/derivatives` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->derivatives()<br>    ->send(<br>        $q->withIncludeTickers('string')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->derivatives()->exchanges()<br>    ->send(<br>        $q->withOrder('string')<br>        ->withPerPage('integer')<br>        ->withPage('integer')<br>    );</pre></code>|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->derivatives()->exchanges('{id}')<br>    ->send(<br>        $q->withIncludeTickers('string')<br>    );</pre></code>|
...
| <i>sample</i> |     ```php $result = \$apiClient->set()->derivatives()->exchanges()->list()->send();```|
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->exchanges('{id}')->volumeChart()<br>    ->send(<br>        $q->withDays('integer')<br>    );</pre></code>|


# <h2 id='cust-nfts--beta-'>_WW_ nfts (beta) </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/nfts/list` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->nfts()->list()<br>    ->send(<br>        $q->withOrder('string')<br>        ->withAssetPlatformId('string')<br>        ->withPerPage('integer')<br>        ->withPage('integer')<br>    );</pre></code>|
| <b>2.<b>   | `/nfts/{id}` |
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->nfts('{id}')->send();```|
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->nfts('{asset_platform_id}')->contract('{contract_address}')->send();```|


# <h2 id='cust-exchange_rates'>_WW_ exchange_rates </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.</b>   | `/exchange_rates`  |
|                        | <code>exchangeRates()</code> <br><br><blockquotes>Get BTC-to-Currency exchange rates<blockquotes><br><br> |
| <i>sample</i> |     ```php $result = \$apiClient->set()->exchangeRates()->send();```|


# <h2 id='cust-search'>_WW_ search </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.<b>   | `/search` |
...
| <i>sample</i> |<code><pre>```php $result = \$apiClient->set()->search()<br>    ->send(<br>        $q->withQuery('string')<br>    );</pre></code>|


# <h2 id='cust-trending'>_WW_ trending </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
...
| <i>sample</i> |     ```php $result = \$apiClient->set()->search()->trending()->send();```|


# <h2 id='cust-global'>_WW_ global </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
| <b>1.</b>   | `/global`  |
|                        | <code>global()</code> <br><br><blockquotes>Get cryptocurrency global data<blockquotes><br><br> |
| <i>sample</i> |     ```php $result = \$apiClient->set()->global()->send();```|
...
| <i>sample</i> |     ```php $result = \$apiClient->set()->global()->decentralizedFinanceDefi()->send();```|


# <h2 id='cust-companies--beta-'>_WW_ companies (beta) </h2>
| ENDPOINT <a href='#table-of-contents'>_TT_</a>| |
|---:|:---|
...
| <i>sample</i> |    ```php $result = \$apiClient->set()->companies()->publicTreasury('{coin_id}')->send();```|
